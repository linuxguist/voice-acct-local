...
// console.log(Array.from([1, 2, 3], (x) => x + '.mp3'));
    ...
    const audioFiles = Array.from(testxi.toString().replaceAll('.', '`'), (x) => 'region/' + filemaps[x] + '.mp3')
...
if (e.key !== "Enter" && typeof filemaps[e.key] !== 'undefined') {
// console.log(filemaps[e.key]);  
var myaudio = new Audio('region/' + filemaps[e.key] + '.mp3');
myaudio.play();
}
...
if (e.key >= 0 && e.key <= 9) {
  ...
  e.stopPropagation();
  // document.getElementById(filemaps[e.key]).play();
...
*/
  ...
  event.preventDefault();
   // document.getElementById(filemaps['`']).play(); 
  document.getElementById("period").click();
} else if (e.key == "+") {
  event.preventDefault();
   // document.getElementById(filemaps['P']).play(); 
  ...
  event.preventDefault();
   // document.getElementById(filemaps['MU']).play(); 
  document.getElementById("op-multiply").click();
} else if (e.key == "/") {
  event.preventDefault();
   // document.getElementById(filemaps['D']).play(); 
  document.getElementById("op-divide").click();
} else if (e.key == "Backspace") {
  event.preventDefault();       
  // document.getElementById(filemaps['B']).play(); 
  document.getElementById("delete").click();
} else if (e.key == "Escape") {
  event.preventDefault();       
  // document.getElementById(filemaps['E']).play(); 
  document.getElementById("clear").click();
} else if (event.keyCode == 12) {
  event.preventDefault();       
  // document.getElementById(filemaps['NL']).play(); 
  // document.getElementById("clear").click();
}  
}, false);
